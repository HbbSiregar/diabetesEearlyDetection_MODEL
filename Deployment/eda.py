...
Ini adalah **gejala fisiologis paling awal dan khas pada diabetes,** maka tidak mengherankan jika grafik menunjukkan dominasi keduanya.
        ...
        Referensi : <a href="https://my.clevelandclinic.org/health/diseases/21945-diabetic-ketoacidosis-dka?utm">clevelandclinic : ketika orang punya sedikit insulin</a>
        </div> """, unsafe_allow_html=True)
